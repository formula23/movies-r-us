                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.auth.user" :href="route('movies.index')" :active="route().current('movies.*')">
                                    Movies
                                </NavLink>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button v-if="$page.props.auth.user" type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
